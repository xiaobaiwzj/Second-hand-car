...
var Scrollbar = /** @class */ (function (_super) {
    ...
    Scrollbar.prototype.layout = function () {
        ...
        if (this.scrollbar) {
            ...
            if (cfg.isHorizontal) {
                ...
                var _c = direction_1.directionToPosition(this.view.viewBBox, bbox, constant_1.DIRECTION.RIGHT), x1 = _c[0], y1 = _c[1];
                var _d = direction_1.directionToPosition(this.view.viewBBox, bbox, constant_1.DIRECTION.RIGHT), x2 = _d[0], y2 = _d[1];
                x = x2;
                y = y1;
            }
            x += padding[3];
            ...
            // 默认放在 bottom
            if (this.trackLen) {
                this.scrollbar.component.update(tslib_1.__assign(tslib_1.__assign({}, cfg), { x: x,
    ...
    Scrollbar.prototype.getScrollbarComponentCfg = function () {
        ...
        return tslib_1.__assign(tslib_1.__assign({}, this.getThemeOptions()), { x: position.x, y: position.y, size: isHorizontal ? height : width, isHorizontal: isHorizontal,
            trackLen: trackLen,
